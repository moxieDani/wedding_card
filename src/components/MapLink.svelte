...
function handleClick(event) {
  ...
  window.open(바로가기.kakao, 'popup', 'width=max,height=max');
}
</script>
...
<div class="flex-center map-icons">
  ...
  <div>
    ...
    <a id="share-location" on:click={shareLocation} target="_blank">
      <img class="map-icon" src={kakaoNaviIcon} alt="길 안내하기 버튼" style="border-radius: 20%;" />
    </a>
